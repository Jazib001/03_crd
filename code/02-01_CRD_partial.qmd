...
ggplot(crd_dfw, aes(x = nrate_kgha,
                    y = yield_kgha,
                    color = nrate_kgha)) + geom_boxplot() + geom_point()

ggplot(crd_dfw, aes(x = nrate_kgha,
                    y = yield_kgha,
                    color = nrate_kgha)) + geom_boxplot() + 
                    geom_jitter()
...
crd_mod = lm(yield_kgha ~ nrate_kgha + krate_kgha +nrate_kgha:krate_kgha, data = crd_dfw)
...
ggplot(crd_resid, aes(x = .fitted,
  ...
  geom_point(shape = 21,
             ...
             size = 3,
             alpha = 7) +
  geom_hline(yintercept = c(-3, 0, 3), color = "green") 
